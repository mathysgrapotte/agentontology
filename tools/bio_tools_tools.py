...
@tool
def get_biotools_ontology_input(tool_name:str, entry_id:str) -> list:
    """
...
@tool
def get_biotools_ontology_output(tool_name:str, entry_id:str) -> list:
    """
    Given a specific entry of the tools list associated to the module, return the biotools output ontology ID. 
    ...
    Returns:
        list: The biotools ontology ID assoiated to each possible output file.
    """
